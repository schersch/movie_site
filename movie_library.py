import movies  # import a class to hold movie objects
import fresh_tomatoes  # used for 'open_movies_page' which builds html file
...
# put movies in a list for fresh_tomatoes
movies = [pi, shawshank_redemption, good_will_hunting, fountain,
          v_for_vendetta, thank_you_for_smoking, garden_state,
          fifth_element, dark_knight, se7en, gladiator, american_beauty,
          charade, amelie, snatch, holy_grail]
# generate an html page to display movies
